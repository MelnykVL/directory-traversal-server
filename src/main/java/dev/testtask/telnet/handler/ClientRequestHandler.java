...
public class ClientRequestHandler implements Runnable {
    ...
    public void run() {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(clientSocket.getInputStream()));
             PrintWriter writer = new PrintWriter(clientSocket.getOutputStream(), true); clientSocket) {
            ...
            while (proceed) {
                ...
                List<String> fileList = searchService.search(searchSetting.rootPath(),
                                                             searchSetting.depth(),
                                                             searchSetting.mask()).get();
